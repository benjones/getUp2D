...
public class ParameterizedLyingGenerator implements
	...
	public SupportPattern getPattern(float[] parameters) {
		...
		sp.addLimbStatus(supportLabel.rightLeg,
				...
				new supportInfo(limbStatus.swing, true,
						parameters[lyingParamOffsets.rlOffset1.ordinal()]));
		sp.addLimbStatus(supportLabel.rightLeg,
		...
		sp.addLimbStatus(supportLabel.leftLeg,
				...
				new supportInfo(limbStatus.swing, false,
						parameters[lyingParamOffsets.llOffset2.ordinal()]));
		sp.addLimbStatus(supportLabel.leftLeg,
				parameters[lyingParamOffsets.llTime4.ordinal()],
				new supportInfo(limbStatus.stance, false, 0f));

		sp.addLimbStatus(supportLabel.rightLeg,
				parameters[lyingParamOffsets.rlTime3.ordinal()],
				new supportInfo(limbStatus.stance, false, 0f));
